...
var createAllFormSubmissionsByNameAndEntityIDView = function () {
    return repository.createView(dristhiFormDb, '_design/FormSubmission_Temp', {
...
var createAllOpenANCsView = function () {
    return repository.createView(dristhiDb, '_design/Mother_Temp', {
            allOpenANCs: {
                map: function (doc) {
...
var getAllOpenANCs = function () {
    return repository.queryView(dristhiDb, 'Mother_Temp/allOpenANCs');
};
...
var getAllANCVisitsForANC = function (response) {
    ...
    return repository.queryView(dristhiFormDb, 'FormSubmission_Temp/byFormNameAndEntityId',
        {
...
var updateMotherDocument = function (openANCs) {
    ...
    return repository.save(dristhiDb, ancs);
};
